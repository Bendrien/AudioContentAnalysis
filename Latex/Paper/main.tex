...
In section \ref{sec:algo} there will be a detailed explanation of how NMF works.
...
The first one contains the magnitude spectra of the individual components we are interested in and the second one contains the time-varying gain of these components, which tells us when each of the components for the first matrix is active.
