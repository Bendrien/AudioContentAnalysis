...
\caption{Example of the representation of an activation matrix as a curve. \scriptsize{\textsf{\textcopyright} Own work CC BY-SA 3.0}}
...
Afterwards a threshold of $\frac{2}{3}$ is applied.
